...
const homepage = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <View style={tw`items-center justify-center flex-1 px-6 bg-yellow-100`}>
      ...
      <View>
        <Animatable.View>
          <TouchableOpacity
            style={tw`w-full py-2 mt-5 bg-yellow-400 rounded-full px-14`}
            onPress={goTo}
          >
        ...
        <Animatable.View>
          <TouchableOpacity
            style={tw`w-full py-2 mt-3 mb-5 bg-yellow-400 rounded-full px-14`}
            onPress={GoTO}
          >
