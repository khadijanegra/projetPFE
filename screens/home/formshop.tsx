    ...
    <ScrollView style={tw`bg-red-100`} contentContainerStyle={tw`p-4`}>
      ...
      >
        ...
        <View style={tw`mb-8`}>
          ...
          {/* Shop Name */}
          <View style={tw`flex-row items-center p-3 mb-4 bg-white shadow-sm rounded-xl`}>
            <Ionicons name="business" size={20} color="#212121" style={tw`mr-3`} />
            <TextInput
          ...
          {/* Phone Number */}
          <View style={tw`flex-row items-center p-3 mb-4 bg-white shadow-sm rounded-xl`}>
            <FontAwesome name="phone" size={20} color="#212121" style={tw`mr-3`} />
            <TextInput
              style={tw`flex-1 text-gray-700`}
        ...
        <View style={tw`mb-8`}>
          ...
          <View style={tw`flex-row items-center p-3 bg-white shadow-sm rounded-xl`}>
            <Ionicons name="location-sharp" size={20} color="#212121" style={tw`mr-3`} />
            <TextInput
              style={tw`flex-1 text-gray-700`}
          ...
          >
            {shopImage ? (
              ...
              <>
                ...
                <Text style={tw`mt-2 text-blue-600`}>Télécharger votre Image</Text>
        ...
        <TouchableOpacity onPress={handleSubmit}>
          <Text style={tw`p-4 text-lg font-bold text-center text-white bg-red-300 rounded-xl`}>
            Valider la création
          </Text>
        </TouchableOpacity>
        ...
        <Modal animationType="fade" transparent={true} visible={modalVisible}>
          <View style={tw`items-center justify-end flex-1 bg-black bg-opacity-50`}>
            <Animated.View
              style={[tw`items-center w-full p-8 bg-white rounded-t-3xl`, { transform: [{ translateY: slideAnim }] }]}
            >
              <Image
                source={require("../../images/Illustration.png")}
                style={tw`w-40 h-40 mb-4 rounded-full`}
              />
              <Text style={tw`mb-2 text-2xl font-bold text-gray-900`}>Félicitations !</Text>
